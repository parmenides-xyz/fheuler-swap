...
interface IFHERC20 {
     ...
     */
    function transferEncrypted(address to, inEuint8 calldata value) external returns (euint8);
    function transferEncrypted(address to, euint8 value) external returns (euint8);
     ...
     */
    function approveEncrypted(address spender, inEuint8 calldata value) external returns (bool);
     ...
     * Emits a {TransferEncrypted} event.
     */
    function transferFromEncrypted(address from, address to, inEuint8 calldata value) external returns (euint8);
    function transferFromEncrypted(address from, address to, euint8 value) external returns (euint8);
}
